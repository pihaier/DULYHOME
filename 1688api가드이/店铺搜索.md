...
paths:
  /alibaba/product/shopQuery:
    get:
      ...
      deprecated: false
      description: >-
        请提交店铺的sellerOpenId查询店铺内商品，sellerOpenId可通过【商品详情搜索接口】获取，开通多语言，请联系客服，英语："en",
      ...
      parameters:
        ...
        - name: sellerOpenId
          in: query
          description: 商家店铺id脱敏，可通过商品详情搜索接口获取
          required: true
          example: BBBEjczPHMQ_zHE-67YyNGXyw
          schema:
            type: string
        - name: keyword
          in: query
          description: 请使用中文关键词，如果是非中文请自行翻译，可空
          required: false
          schema:
            type: string
        - name: beginPage
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/4330288/apis/api-218067883-run
components:
  schemas: {}
  securitySchemes: {}
servers:
