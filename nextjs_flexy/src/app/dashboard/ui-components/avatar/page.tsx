      ...
      <Grid container spacing={3}>
        ...
        >
          <ChildCard title="Sizes" codeModel={<SizesCode />}>
            <Stack direction="row" spacing={1} justifyContent="center">
              <Avatar alt="Remy Sharp" src={'/images/users/2.jpg'} sx={{ width: 24, height: 24 }} />
              <Avatar alt="Remy Sharp" src={'/images/users/3.jpg'} sx={{ width: 32, height: 32 }} />
              <Avatar alt="Remy Sharp" src={'/images/users/4.jpg'} />
              <Avatar alt="Remy Sharp" src={'/images/users/5.jpg'} sx={{ width: 50, height: 50 }} />
              <Avatar alt="Remy Sharp" src={'/images/users/6.jpg'} sx={{ width: 60, height: 60 }} />
              <Avatar alt="Remy Sharp" src={'/images/users/7.jpg'} sx={{ width: 65, height: 65 }} />
            </Stack>
          </ChildCard>
        </Grid>
      </Grid>
