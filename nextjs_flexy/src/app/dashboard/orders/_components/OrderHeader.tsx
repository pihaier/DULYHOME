...
export default function OrderHeader({
  ...
  const getServiceTitle = () => {
    switch(serviceType) {
      case 'market_research': return '수입대행 - 시장조사';
      case 'inspection': return '검품감사 서비스';
      case 'sampling': return '수입대행 - 샘플링';
      case 'bulk_order': return '수입대행 - 대량주문';
      default: return '주문 상세';
    }
  };
                ...
                <Chip
                  ...
                  sx={{
                    bgcolor: status === 'completed' ? 'success.main' : 
                            ...
                            status === 'paid' ? 'info.main' : 'grey.300',
                    color: 'white',
                    fontWeight: 'bold'
                  }}
                />
