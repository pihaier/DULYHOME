        ...
        >
          ...
          <Box sx={{ flex: 1 }}>
            <Box>
              ...
              <Typography variant="body2">{orderData.contact_person}</Typography>
          ...
          {orderData.serviceType === 'market_research' && (
            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2 }}>
              ...
              <Box sx={{ minWidth: '200px', flex: 1 }}>
                ...
                <Typography variant="body2">
                  {orderData.serviceData.research_duration_days}일
                </Typography>
              </Box>
            </Box>
          )}
              ...
              <Box sx={{ minWidth: '200px', flex: 1 }}>
                ...
                <Typography variant="body2">
                  {orderData.serviceData.desired_delivery_date
                    ? new Date(orderData.serviceData.desired_delivery_date).toLocaleDateString(
                        'ko-KR'
                      )
                    : '미정'}
                </Typography>
