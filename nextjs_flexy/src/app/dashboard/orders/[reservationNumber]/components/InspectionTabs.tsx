        ...
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 3 }}>
          <Box sx={{ flex: 1 }}>
            ...
            <List>
              ...
              <ListItem divider>
                <ListItemText primary="제품명" secondary={serviceData.product_name || '미입력'} />
              </ListItem>
              <ListItem divider>
                <ListItemText
                  primary="제품명 (번역)"
                ...
                <ListItemText
                  ...
                  secondary={
                    <Box sx={{ display: 'inline-flex', alignItems: 'center' }}>
                      <Chip
                        label={
                          serviceData.schedule_coordination_status === 'coordinated'
                            ? '조율완료'
                            : '조율중'
                        }
                        color={
      ...
      <TabPanel value={value} index={1}>
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 3 }}>
          <Box sx={{ flex: 1 }}>
            ...
            <List>
              <ListItem divider>
                <ListItemText primary="공장명" secondary={serviceData.factory_name || '미입력'} />
              </ListItem>
              <ListItem divider>
                <ListItemText
                  primary="담당자"
      ...
      <TabPanel value={value} index={2}>
        <Box>
          <Box sx={{ mb: 3 }}>
            <Alert
              severity={
                serviceData.schedule_coordination_status === 'coordinated' ? 'success' : 'warning'
              }
              sx={{ mb: 3 }}
            >
              일정 조율 상태:{' '}
              {serviceData.schedule_coordination_status === 'coordinated' ? '완료' : '진행 중'}
            </Alert>
          </Box>
              ...
              <List>
                <ListItem divider>
                  <ListItemText
                    primary="희망 시작일"
                    secondary={
                      serviceData.inspection_start_date
                ...
                <ListItem divider>
                  <ListItemText
                    primary="확정 시작일"
                    secondary={
                      serviceData.confirmed_start_date
                ...
                <ListItem>
                  <ListItemText
                    primary="확정 종료일"
                    secondary={
                      serviceData.confirmed_end_date
        ...
        <Box>
          ...
          <Box>
            ...
            <List>
              ...
              <ListItem>
                <ListItemText primary="• 사진 자료" secondary="제품 및 포장 상태 사진" />
              </ListItem>
              <ListItem>
                <ListItemText primary="• 개선 권고사항" secondary="품질 향상을 위한 전문가 의견" />
              </ListItem>
            </List>
          </Box>
        </Box>
