              ...
              <CardContent>
                          ...
                          <FormControlLabel
                            control={
                              <Checkbox
                                ...
                                onChange={(e) =>
                                  setFormData({ ...formData, privacy_accepted: e.target.checked })
                                }
                                disabled={loading}
                              />
                            }
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              ...
                              onChange={(e) =>
                                setFormData({ ...formData, marketing_accepted: e.target.checked })
                              }
                              disabled={loading}
                            />
                          }
                          label={
                            <Typography variant="body2">마케팅 정보 수신 동의 (선택)</Typography>
                          }
                        />
                      </Stack>
                    </Stack>
                ...
                <Alert severity="info" sx={{ mt: 2 }}>
                  <Typography variant="caption">
                    <strong>개인정보 제3자 제공 안내:</strong> 서비스 제공을 위해 OpenAI(GPT-4
                    번역), AWS(클라우드 인프라), Supabase(데이터베이스), 중국 현지 협력사 등에
                    필요한 정보가 제공됩니다. 자세한 내용은 개인정보처리방침을 확인해주세요.
                  </Typography>
                </Alert>
              </CardContent>
            </Card>
