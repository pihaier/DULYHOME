...
const bannerbgImg1 = '/images/landingpage/bannerimg1.png';
const bannerbgImg2 = '/images/landingpage/bannerimg2.png';
...
const Banner = () => {
  ...
  return (
    <Box pb={10} sx={{ backgroundColor: (theme) => theme.palette.background.paper }}>
