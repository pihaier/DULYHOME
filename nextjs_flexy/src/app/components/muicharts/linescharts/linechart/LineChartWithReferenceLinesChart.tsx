...
export default function LineChartWithReferenceLines() {
  ...
  return (
    <ParentCard title="ReferenceLine Chart" codeModel={<LineChartWithReferenceLinesCode />}>
      <ChartContainer
        width={800}
        height={300}
        series={[
      ...
      >
        <LinePlot />
        <MarkPlot />
        <ChartsReferenceLine x="March" label="Max Profits" lineStyle={{ stroke: Linecolor }} />
        <ChartsReferenceLine y={9800} label="Max" lineStyle={{ stroke: Linecolor }} />
        <ChartsXAxis />
        <ChartsYAxis />
      </ChartContainer>
    </ParentCard>
