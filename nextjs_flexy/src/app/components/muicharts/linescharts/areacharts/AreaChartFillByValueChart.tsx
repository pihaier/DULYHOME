  ...
  return (
    <ParentCard title=" FillByValue Chart" codeModel={<AreaChartFillByValueCode />}>
      <Stack direction="column" width="100%" spacing={1}>
        ...
        >
          <ColorSwich color1={primary} color2={amtDatacolor} threshold={0} id="swich-color-id-1" />
  ...
  return (
    <defs>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse" // Use the SVG coordinate instead of the component ones.
      >
        <stop offset={safeScale(5000) / svgHeight} stopColor={green[400]} stopOpacity={1} />
        <stop offset={safeScale(4000) / svgHeight} stopColor={green[400]} stopOpacity={1} />
        <stop offset={safeScale(4000) / svgHeight} stopColor={green[300]} stopOpacity={1} />
        <stop offset={safeScale(3000) / svgHeight} stopColor={green[300]} stopOpacity={1} />
        <stop offset={safeScale(3000) / svgHeight} stopColor={green[200]} stopOpacity={1} />
        <stop offset={safeScale(2000) / svgHeight} stopColor={green[200]} stopOpacity={1} />
        <stop offset={safeScale(2000) / svgHeight} stopColor={green[100]} stopOpacity={1} />
        <stop offset={safeScale(1000) / svgHeight} stopColor={green[100]} stopOpacity={1} />
        <stop offset={safeScale(1000) / svgHeight} stopColor={green[50]} stopOpacity={1} />
        ...
        <stop offset={safeScale(-1000) / svgHeight} stopColor={red[100]} stopOpacity={1} />
        <stop offset={safeScale(-1000) / svgHeight} stopColor={red[200]} stopOpacity={1} />
        <stop offset={safeScale(-2000) / svgHeight} stopColor={red[200]} stopOpacity={1} />
        <stop offset={safeScale(-3000) / svgHeight} stopColor={red[300]} stopOpacity={1} />
      </linearGradient>
    </defs>
  );
}
