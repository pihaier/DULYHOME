      ...
      <Grid display="flex" alignItems="stretch" size={12}>
        <ChildCard title="Filled" codeModel={<FilledCode />}>
          <InlineItemCard>
            ...
            <Chip
              avatar={<Avatar alt="Natacha" src={'/images/profile/user-4.jpg'} />}
            ...
            />
            <Chip
              avatar={<Avatar alt="Natacha" src={'/images/profile/user-2.jpg'} />}
            ...
            />
            <Chip
              avatar={<Avatar alt="Natacha" src={'/images/profile/user-3.jpg'} />}
              label="Default Filled"
              color="error"
            />
            <Chip
