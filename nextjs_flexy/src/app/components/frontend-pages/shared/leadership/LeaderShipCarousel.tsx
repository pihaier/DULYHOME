      ...
      <Slider {...settings} className="leadership-carousel">
        <div style={slideStyle}>
          ...
          >
            ...
            <Typography variant="body1">대표이사 • 무역전문가</Typography>
          </UserBox>
        </div>
        <div style={slideStyle}>
          <Image
          ...
          >
            ...
            <Typography variant="body1">중국지사장 • 현지총괄</Typography>
          </UserBox>
        </div>
        <div style={slideStyle}>
          <Image
          ...
          >
            ...
            <Typography variant="body1">품질관리팀장 • 검품전문</Typography>
          </UserBox>
        </div>
        <div style={slideStyle}>
          <Image
          ...
          >
            ...
            <Typography variant="body1">무역실무팀장 • 통관전문</Typography>
          </UserBox>
        </div>
        <div style={slideStyle}>
          <Image
