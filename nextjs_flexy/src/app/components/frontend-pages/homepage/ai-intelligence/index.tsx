...
import { Box, Grid, Typography, Container, Card, CardContent, Avatar, Chip, LinearProgress, Button } from "@mui/material";
import { styled } from "@mui/material/styles";
import { useTheme } from "@mui/material/styles";
import { IconBrain, IconChartLine, IconClock, IconShieldCheck, IconLanguage, IconRobot, IconEye } from "@tabler/icons-react";
                                        ...
                                        <Box sx={{ mt: 'auto' }}>
                                            ...
                                            {service.demoPath && (
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        const serviceType = service.demoPath.includes('market-research') ? 'market-research' :
                                                                          service.demoPath.includes('factory-contact') ? 'factory-contact' :
                                                                          service.demoPath.includes('inspection') ? 'inspection' : null;
                                                        if (serviceType) {
