...
const ExceptionalFeature = () => {
  ...
  const StyledAnimationContent = styled(Box)(() => ({
    animation:
      theme.direction == 'ltr' ? 'marquee 25s linear infinite' : 'marqueeRtl 45s linear infinite',
  }));

  const StyledAnimationContent2 = styled(Box)(() => ({
    animation:
      theme.direction == 'ltr' ? 'marquee2 25s linear infinite' : 'marquee2Rtl 45s linear infinite',
  }));
