        ...
        <Grid
          ...
          <Box mt={7}>
            <StyledAccordian expanded={expanded} onChange={handleChange}>
              ...
              <AccordionDetails>
                시장조사, 업체 컨택, 제품 조사, 생산 관리, 품질 검수, 물류, 통관, 배송까지 모든 과정이 포함됩니다. 추가로 현지 직접 출장 검품 서비스를 무료로 제공해드립니다.
              </AccordionDetails>
            </StyledAccordian>
            <StyledAccordian expanded={expanded2} onChange={handleChange2}>
              ...
              <AccordionDetails>
                프로젝트별 맞춤 견적을 제공해드립니다. 기본 수수료 외에는 별도의 정기 결제나 숨겨진 비용이 없으며, 투명한 가격 정책을 유지하고 있습니다.
              </AccordionDetails>
            </StyledAccordian>
            <StyledAccordian expanded={expanded3} onChange={handleChange3}>
              ...
              <AccordionDetails>
                중국 현지에 상주하는 전문 검품팀이 직접 공장을 방문하여 제품 품질, 수량, 포장 상태 등을 철저히 검수합니다. 검품 결과는 상세한 보고서와 사진으로 실시간 공유해드립니다.
              </AccordionDetails>
            </StyledAccordian>
            <StyledAccordian expanded={expanded4} onChange={handleChange4}>
              ...
              <AccordionDetails>
                저희 전문 통관팀이 모든 문제를 신속히 해결해드립니다. 7년간의 경험으로 대부분의 통관 이슈에 대한 해결 방안을 보유하고 있으며, 문제 발생 시 즉시 대응합니다.
              </AccordionDetails>
            </StyledAccordian>
            <StyledAccordian expanded={expanded5} onChange={handleChange5}>
              ...
              <AccordionDetails>
                최소 주문 수량은 제품과 공급업체에 따라 다릅니다. 소량 주문도 가능한 업체를 연결해드리며, 고객님의 니즈에 맞는 최적의 조건을 협상해드립니다.
              </AccordionDetails>
            </StyledAccordian>
            <StyledAccordian expanded={expanded6} onChange={handleChange6}>
              ...
              <AccordionDetails>
                제품 하자 발생 시 중국 공급업체와의 직접 소통을 대행해드립니다. 클레임 접수부터 처리까지 전 과정을 관리하며, 필요시 현지 방문을 통해 문제를 해결합니다.
              </AccordionDetails>
            </StyledAccordian>
          </Box>
        </Grid>
