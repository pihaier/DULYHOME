  ...
  const services = [
    {
      ...
      color: '#1976d2',
      highlights: ['제품 단가 및 시장 분석', '공급업체 검증', '품질 기준 확인'],
    ...
    },
    {
      ...
      color: '#388e3c',
      highlights: ['제품 샘플 수급', '품질 검증 및 테스트', '한국 배송 및 통관'],
    ...
    },
    {
      ...
      color: '#f57c00',
      highlights: ['대량 주문 협상', '최적 가격 확보', '품질 관리 및 검수'],
    ...
    },
    {
      ...
      color: '#7b1fa2',
      highlights: ['품질검품 서비스', '공장감사 서비스', '선적검품 서비스'],
      ...
      <Container sx={{ maxWidth: '1400px !important' }}>
        ...
        <Stack spacing={3} alignItems="center" textAlign="center" mb={8}>
          ...
          <Typography variant="h6" color="text.secondary" sx={{ maxWidth: '800px' }}>
            고객의 다양한 요구사항에 맞춘 4가지 전문 서비스를 제공하여
            <br />
            성공적인 중국 진출을 지원합니다
          </Typography>
        </Stack>
            ...
            <CardContent sx={{ p: 6 }}>
              <Stack spacing={3} alignItems="center">
                ...
                <Typography variant="h6" sx={{ opacity: 0.9, maxWidth: '600px' }}>
                  고객님의 비즈니스에 최적화된 서비스 조합을 제안해드립니다.
                  <br />
