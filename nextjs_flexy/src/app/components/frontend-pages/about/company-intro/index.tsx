  ...
  const advantages = [
    {
      ...
      title: '7년간의 검증된 경험',
      description:
        '2018년부터 쌓아온 한-중 무역 전문 노하우로 안전하고 신뢰할 수 있는 서비스를 제공합니다.',
    },
    {
      icon: <Language />,
      title: '원활한 소통',
      description:
        '현지 중국 직원과 한국 전담팀의 완벽한 이중 언어 서비스로 의사소통 문제를 해결합니다.',
    },
    {
      icon: <Security />,
      title: '투명한 프로세스',
          ...
          <Grid size={{ xs: 12, lg: 6 }}>
            <Stack spacing={4}>
              ...
              <Typography variant="body1" lineHeight={1.8} color="text.secondary">
                <strong>두리무역</strong>은 2018년 설립 이래 <strong>7년간</strong> 한-중 무역
                분야에서 축적한 전문성을 바탕으로, 중소기업과 개인 사업자들이 중국 시장에 안전하고
                효율적으로 진출할 수 있도록 돕는 <strong>무역 전문 서비스 기업</strong>입니다.
              </Typography>

              <Typography variant="body1" lineHeight={1.8} color="text.secondary">
                광저우와 서울에 사무실을 운영하며, <strong>현지 중국 직원 10명</strong>과
                <strong>한국 전담팀 5명</strong>이 긴밀하게 협력하여 고객의 성공적인 중국 무역을
                지원합니다. 복잡한 중국 시장에서 발생할 수 있는 언어 장벽, 품질 문제, 신뢰성 이슈를
                완벽하게 해결합니다.
              </Typography>

              <Typography variant="body1" lineHeight={1.8} color="text.secondary">
                <strong>1,000개 이상의 기업</strong>이 두리무역과 함께 성공적인 중국 무역을
                진행했으며, 시장조사부터 검품감사까지 <strong>원스톱 토탈 솔루션</strong>을 통해
                고객의 시간과 비용을 절약합니다.
              </Typography>
            </Stack>
          </Grid>
