...
import { Box, Container, Typography, Card, CardContent, Stack, Alert, Button } from '@mui/material';
...
export default function PurchaseAgencyPage() {
  ...
  return (
    <PageContainer
      title="구매대행 서비스"
      description="중국 제품의 구매부터 배송까지 원스톱 서비스"
    >
      <HpHeader />
            ...
            <Stack spacing={3} alignItems="center">
              ...
              <Alert severity="info" sx={{ width: '100%', mt: 3 }}>
                ...
                <Typography variant="body2">
                  구매대행 서비스는 현재 준비 중입니다. 빠른 시일 내에 최고의 서비스로
                  찾아뵙겠습니다.
                </Typography>
              </Alert>
